...
[["ice-prefix"]] module IceFlix {
    ...
    interface MediaCatalog {
        ...
        void updateDB(MediaDBList catalogDatabase, string srvId) throws UnknownService; //HECHO
    };
    ...
    interface Authenticator {
        string refreshAuthorization(string user, string passwordHash) throws Unauthorized;//HECHO
        bool isAuthorized(string userToken);
        string whois(string userToken) throws Unauthorized;//HECHO

        void addUser(string user, string passwordHash, string adminToken) throws Unauthorized, TemporaryUnavailable;//HECHO
        void removeUser(string user, string adminToken) throws Unauthorized, TemporaryUnavailable; //HECHO

        void updateDB(UsersDB currentDatabase, string srvId) throws UnknownService; //HECHO
    };
    ...
    interface Main {
        Authenticator* getAuthenticator() throws TemporaryUnavailable; //HECHO
        MediaCatalog* getCatalog() throws TemporaryUnavailable; //HECHO

        void updateDB(VolatileServices currentServices, string srvId) throws UnknownService; //HECHO
